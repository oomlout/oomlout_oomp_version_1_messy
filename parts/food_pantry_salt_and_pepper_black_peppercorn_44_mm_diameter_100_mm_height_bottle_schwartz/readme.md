# Food Pantry Salt And Pepper Black Peppercorn 44 mm Diameter 100 mm Height Bottle Schwartz  
...
| bip_39_word_dash_10 | two-margin-state-swallow-grass-polar-define-edit-real-window |  
| bip_39_word_dash_11 | two-margin-state-swallow-grass-polar-define-edit-real-window-ahead |  
| bip_39_word_dash_12 | two-margin-state-swallow-grass-polar-define-edit-real-window-ahead-arrive |  
| bip_39_word_dash_2 | two-margin |  
| bip_39_word_dash_3 | two-margin-state |  
| bip_39_word_dash_4 | two-margin-state-swallow |  
| bip_39_word_dash_5 | two-margin-state-swallow-grass |  
| bip_39_word_dash_6 | two-margin-state-swallow-grass-polar |  
| bip_39_word_dash_7 | two-margin-state-swallow-grass-polar-define |  
| bip_39_word_dash_8 | two-margin-state-swallow-grass-polar-define-edit |  
| bip_39_word_dash_9 | two-margin-state-swallow-grass-polar-define-edit-real |  
| bip_39_word_new_br_1 | two |  
| bip_39_word_new_br_10 | two<br>margin<br>state<br>swallow<br>grass<br>polar<br>define<br>edit<br>real<br>window |  
| bip_39_word_new_br_11 | two<br>margin<br>state<br>swallow<br>grass<br>polar<br>define<br>edit<br>real<br>window<br>ahead |  
| bip_39_word_new_br_12 | two<br>margin<br>state<br>swallow<br>grass<br>polar<br>define<br>edit<br>real<br>window<br>ahead<br>arrive |  
| bip_39_word_new_br_2 | two<br>margin |  
| bip_39_word_new_br_3 | two<br>margin<br>state |  
| bip_39_word_new_br_4 | two<br>margin<br>state<br>swallow |  
| bip_39_word_new_br_5 | two<br>margin<br>state<br>swallow<br>grass |  
| bip_39_word_new_br_6 | two<br>margin<br>state<br>swallow<br>grass<br>polar |  
| bip_39_word_new_br_7 | two<br>margin<br>state<br>swallow<br>grass<br>polar<br>define |  
| bip_39_word_new_br_8 | two<br>margin<br>state<br>swallow<br>grass<br>polar<br>define<br>edit |  
| bip_39_word_new_br_9 | two<br>margin<br>state<br>swallow<br>grass<br>polar<br>define<br>edit<br>real |  
...
| bip_39_word_underscore_4 | two_margin_state_swallow |  
...
| description_main | black_peppercorn |  
| description_main_capital | Black Peppercorn |  
...
| filter |  |  
| from_yaml | False |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/food_pantry_salt_and_pepper_black_peppercorn_44_mm_diameter_100_mm_height_bottle_schwartz |  
